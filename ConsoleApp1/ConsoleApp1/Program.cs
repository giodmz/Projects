...
//List<string> listaDasBandas = new List<string> {"U2", "The Beatles", "Scorpion"};

Dictionary<string, List<int>> bandasRegistradas = new Dictionary<string, List<int>>();
bandasRegistradas.Add("Linkin Park", new List<int> {10, 8, 6});
bandasRegistradas.Add("The Beatles", new List<int>());
bandasRegistradas.Add("Pato Viúvo", new List<int> { 10, 9, 10});
...
void MediaDaBanda()
{
    ...
    Console.Write("Digite a banda que você deseja ver a média: ");
...
void AvaliarUmaBanda()
{
    ...
    //saber se a banda existe no dicionário >> atribuir uma nota
